...
import ScreensCharact from './Characteristic/screens/characteristic';
...
const Routes = () => (
    <BrowserRouter>
        <Switch>
            ...
            <PrivateRoute path='/Cores' level_required="3" component={ScreensColor} />
            <PrivateRoute path='/Defeitos' level_required="3" component={ScreensDefeito}/>
            <PrivateRoute path='/Caracteristicas' level_required="3" component={ScreensCharact}/>
